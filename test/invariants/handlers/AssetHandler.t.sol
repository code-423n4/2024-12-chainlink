...
contract AssetHandler is Constants, Test {
    ...
    function setAssetSwapParams(
        ...
        SwapAutomator.SwapParams memory currentSwapParams = s_swapAutomator.getAssetSwapParams(
            allowlistedAssets[index]
        );
        ...
        s_swapAutomator.applyAssetSwapParamsUpdates(
            new address[](0),
            SwapAutomator.AssetSwapParamsArgs({assets: swapAssets, assetsSwapParams: swapParams})
        );
    }
