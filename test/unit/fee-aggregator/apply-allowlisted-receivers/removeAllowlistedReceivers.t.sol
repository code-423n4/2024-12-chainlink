...
contract RemoveAllowlistedReceiversUnitTest is BaseUnitTest {
    ...
    function setUp() public {
        ...
        FeeAggregator.AllowlistedReceivers memory removedReceiver = FeeAggregator.AllowlistedReceivers({
    ...
    function test_removeAllowlistedReceivers_RevertWhen_ReceiverIsNotAlreadyAllowlisted() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(Errors.ReceiverNotAllowlisted.selector, SOURCE_CHAIN_1, INVALID_RECEIVER)
        );
