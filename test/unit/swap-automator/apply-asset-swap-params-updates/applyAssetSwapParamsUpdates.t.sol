...
contract ApplyAssetSwapParamsUpdatesUnitTest is BaseUnitTest {
        ...
        whenCallerIsNotAssetManager
    {
        vm.expectRevert(
            abi.encodeWithSelector(
                ...
                OWNER,
                Roles.ASSET_ADMIN_ROLE
            )
        );
        s_swapAutomator.applyAssetSwapParamsUpdates(
            new address[](0),
            SwapAutomator.AssetSwapParamsArgs({assets: s_swapAssets, assetsSwapParams: s_swapParams})
        );
    }
    ...
    function test_applyAssetSwapParamsUpdates_RevertWhen_AssetListLengthDoesNotMatchSwapParamsLength() public {
        ...
        s_swapAutomator.applyAssetSwapParamsUpdates(
            new address[](0),
            SwapAutomator.AssetSwapParamsArgs({assets: assetList, assetsSwapParams: s_swapParams})
        );
    }
    ...
    function test_applyAssetSwapParamsUpdates_RevertWhen_AssetListIsNotAllowlistedOnTheReceiver() public {
        ...
        s_swapAutomator.applyAssetSwapParamsUpdates(
            new address[](0),
            SwapAutomator.AssetSwapParamsArgs({assets: assetList, assetsSwapParams: newSwapParams})
        );
    }
    ...
    function test_applyAssetSwapParamsUpdates_RemoveAsset() public {
        ...
        s_swapAutomator.applyAssetSwapParamsUpdates(
            new address[](0),
            SwapAutomator.AssetSwapParamsArgs({assets: newSwapAssets, assetsSwapParams: newSwapParams})
        );
        ...
        s_swapAutomator.applyAssetSwapParamsUpdates(
            ...
            SwapAutomator.AssetSwapParamsArgs({
                ...
                assetsSwapParams: new SwapAutomator.SwapParams[](0)
            })
        );
    ...
    function test_applyAssetSwapParamsUpdates_AssetAlreadyAllowlisted() public {
        ...
        s_swapAutomator.applyAssetSwapParamsUpdates(
            new address[](0),
            SwapAutomator.AssetSwapParamsArgs({assets: swapAssets, assetsSwapParams: newSwapParams})
        );
