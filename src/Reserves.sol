...
contract Reserves is EmergencyWithdrawer, IERC677Receiver, ITypeAndVersion, ILinkAvailable {
    ...
    event EarmarkSet(
        ...
        uint256 indexed earmarkCounter,
    ...
    constructor(ConstructorParams memory params) EmergencyWithdrawer(params.adminRoleTransferDelay, params.admin) {
    ...
    function setEarmarks(Earmark[] calldata earmarks) external onlyRole(Roles.EARMARK_MANAGER_ROLE) {
    ...
    function withdraw(address[] calldata serviceProviders) external whenNotPaused {
    ...
    function isServiceProviderAllowlisted(address serviceProvider) external view returns (bool) {
